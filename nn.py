...
Riesgos claves: alta exposición a China. Tensiones China–EE.UU. pueden afectar acceso a mercados o tecnología. Riesgo regulatorio de concentración de clientes con dependencia significativa de grandes OEMs, presión sobre márgenes por poder negociador de fabricantes automotrices, posible disrupción por baterías de estado sólido u otras químicas emergentes y riesgo de commodities, volatilidad en precios de litio y níquel, aunque mitigado parcialmente por integración vertical.
El conflicto en la region del oeste asiatico incrementa el riesgo por la dependencia China del suministro de recursos energeticos, y asi mismo, podría tener impacto en la transición a energias verdes, aumentando la volatilidad de CATL, con un riesgo valorado positivamente.
...
Posicionamiento Estratégico: CATL no es solo un fabricante de baterías; es un activo estratégico dentro de la infraestructura de electrificación global. Su liderazgo en cuota de mercado (~37%) le otorga: ventaja en costos, capacidad de inversión en I+D y crea barreras de entrada significativas a nuevos entrantes.</p>
    ...
    with col3:
        ...
        <div class="custom-panel">
            ...
            <ul><li><strong>El conflicto abierto entre EE.UU., Israel e Irán representa un riesgo bidireccional para CATL.
Amenazas: disrupción en rutas marítimas críticas y encarecimiento drástico de los fletes globales, afectando la estructura de costos operativos. <strong>
Oportunidades: un shock petrolero aceleraría la transición forzosa hacia la movilidad eléctrica, disparando la demanda de sus baterías. Para mitigar la vulnerabilidad de la cadena de suministro en África y Medio Oriente, CATL deberá estrechar urgentemente lazos estratégicos con proveedores de minerales en el Triángulo del Litio y latitudes americanas, garantizando un abastecimiento resiliente.</li></ul> <strong>
...
with tab3:
    ...
    with col_f2:
        ...
        <div class="custom-panel">
            ...
            <p>El Test Ácido (Quick Ratio) es una métrica de solvencia exigente. Mide la capacidad de la empresa para cumplir con sus obligaciones financieras a corto plazo utilizando únicamente sus activos más líquidos, descartando los inventarios.</p>
            <div style="background: rgba(88, 166, 255, 0.1); border-left: 4px solid var(--accent-blue); padding: 15px; font-family: monospace; font-size: 15px; margin: 20px 0;">
